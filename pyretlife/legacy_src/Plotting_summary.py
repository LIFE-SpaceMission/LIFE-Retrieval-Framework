...
results = rp.retrieval_plotting(
    "/home/ipa/quanz/user_accounts/konradb/chains/Test_Unit_Retrieval/"
)
...
results.Posteriors(
    ...
    titles=titles,
)  # Titles of parameters. If not provided generated automatically


# Flux envelope code
results.Flux_Error(
    skip=1,  # Skip value for the spectrum calculation
    ...
    quantiles=[
        ...
        0.85,
        0.95,
    ],  # Plotted flux quantiles
    quantiles_title=[
        r"$5-95\%$",
        r"$15-85\%$",
        r"$25-75\%$",
        r"$35-65\%$",
    ],  # Titles for the flux quantiles
    ...
    y_unit=u.photon / u.m**2 / u.s / u.micron,
)  # Astropy units for the y-coordinate


# PT envelope code
results.PT_Envelope(
    skip=1,  # Skip value for the PT calculation
    ...
    true_cloud_top=[
        None,
        None,
    ],  # Position of the true CT [Temperature,pressure]
    quantiles=[
        0.05,
        0.15,
        0.25,
        ...
        0.85,
        0.95,
    ],  # Plotted PT quantiles
    quantiles_title=[
        r"$5-95\%$",
        r"$15-85\%$",
        r"$25-75\%$",
        r"$35-65\%$",
    ],  # Titles for the PT quantiles
