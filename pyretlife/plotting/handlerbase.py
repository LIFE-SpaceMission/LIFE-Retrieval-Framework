...
class Handles(HandlerBase):
    ...
    def create_artists(
        ...
        if orig_handle == "CloudTopPressure":
            l1 = plt.Line2D(
                [0.5 * width], [0.5 * height], marker="s", ms=2.5, color="C4"
            )
            l2 = plt.Line2D(
                [
        ...
        if orig_handle == "SurfacePressure":
            l1 = plt.Line2D(
                [0.5 * width], [0.5 * height], marker="o", ms=2.5, color="C3"
            )
            l2 = plt.Line2D(
                [
                    x0 + 0.5 * width - 0.4 * height,
        ...
        if orig_handle == "ErrorBar":
            ...
            l4 = plt.Line2D(
                [x0, y0 + width], [0.5 * height, 0.5 * height], color="k", lw=2
            )
            return [l1, l2, l3, l4]
            ...
            l6 = plt.Line2D(
                [x0 + 3 * 0.2 * height, x0, x0 + 3 * 0.2 * height],
            ...
            l3 = plt.Line2D(
                [x0, x0 + 0.95 * width],
                [2.0 / 3 * height, 2.0 / 3 * height],
                lw=1,
                color="gray",
                ls="--",
            )
            l4 = plt.Line2D(
                [x0 + 0.04 * width, x0 + 0.91 * width],
                [1 * height, 1 * height],
                lw=1,
                color="gray",
                ls="-",
