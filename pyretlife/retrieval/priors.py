...
def assign_priors(dictionary: dict) -> dict:
    ...
    The prior functions are defined in the priors module. The assign_priors function is called by the read_parameters function, which reads in the parameters from a .yaml file.
...
def read_custom_prior(path: Union[str,Path]) -> ndarray:
    ...
    :param path: Union[str,Path] Specify that the path parameter can be either a string or a path object
    :return:  A dictionary with the prior function assigned to each parameter
    """
...
def gaussian_prior(r: float, prior_specs:dict) -> float:
    """
    Scales a random number generated in a uniform prior between 0 and 1 to the respective value corresponding to a gaussian prior
    centered at mu and of standard deviation sigma. This function is called by the assign_priors function.
...
def log_uniform_prior(r: float, prior_specs:dict) -> float:
    """
    Returns a number like 10^x, where x is generated by scaling a random number generated in a uniform prior between 0 and 1 to the respective value corresponding to a
    uniform prior ranged between x1 and x2. This function is called by the assign_priors function.
...
def upper_log_uniform_prior(r: float, prior_specs:dict) -> float:
    """
    Returns a number like (1-10^x), where x is generated by scaling a random number generated in a uniform prior between 0 and 1 to the respective value corresponding to a
    uniform prior ranged between x1 and x2. This function is called by the assign_priors function.
...
def log_gaussian_prior(r: float, prior_specs:dict) -> float:
    """
    Returns a number like 10^x, where x is generated by scaling a random number generated in a uniform prior between 0 and 1 to the respective value corresponding to a
    gaussian prior ranged between x1 and x2. This function is called by the assign_priors function.
